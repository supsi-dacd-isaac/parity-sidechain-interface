...
if __name__ == "__main__":
    ...
    dt_start = dt_start - datetime.timedelta(minutes=cfg['shiftBackMinutes']['lemClosing'])
    dt_end = dt_end - datetime.timedelta(minutes=cfg['shiftBackMinutes']['lemClosing'])
    ...
    cmd_request = '%s/updateLem' % url_prefix
